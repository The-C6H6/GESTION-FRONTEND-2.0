...
Frontend Flet para gestionar dictámenes de estudiantes de ESIQIE. El login, la consulta de alumnos inscritos, sus materias reprobadas, la creación y la búsqueda paginada de dictámenes consumen la API real; los demás casos de uso continúan con adaptadores de demostración.
...
- Login, búsqueda de inscritos, consulta paginada de materias reprobadas, creación y búsqueda paginada de dictámenes mediante API, con un mismo token Bearer efímero en memoria.
...
- Eliminación y modificación simulada de dictámenes.
